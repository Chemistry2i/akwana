...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-md hover:bg-primary-hover hover:shadow-lg hover:scale-105 active:scale-100",
        destructive: "bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 hover:shadow-md",
        outline: "border-2 border-input bg-transparent hover:bg-accent/10 hover:border-accent",
        ...
        gradient: "gradient-primary text-white shadow-lg hover:shadow-xl hover:scale-105 active:scale-100",
        cta: "bg-accent text-accent-foreground shadow-lg hover:bg-accent-hover hover:shadow-xl hover:scale-105 active:scale-100 font-semibold",
      },
      size: {
